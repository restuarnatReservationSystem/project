...
<body>
    ...
    <div id="main">
        <form id="seat-form" method="POST" action="reservation_session3.php">
            <div id="seat">
                <div class="seat-24">
                    <button type="button" class="seat_2" onclick="selectSeat('1번 테이블')">1번 테이블<br>(2인석)</button>
                    <button type="button" class="seat_4" onclick="selectSeat('2번 테이블')">2번 테이블<br>(4인석)</button>
                    <button type="button" class="seat_2" onclick="selectSeat('3번 테이블')">3번 테이블<br>(2인석)</button>
                    <button type="button" class="seat_4" onclick="selectSeat('4번 테이블')">4번 테이블<br>(4인석)</button>
                </div>
                <div class="seat-24">
                    <button type="button" class="seat_2" onclick="selectSeat('5번 테이블')">5번 테이블<br>(2인석)</button>
                    <button type="button" class="seat_4" onclick="selectSeat('6번 테이블')">6번 테이블<br>(4인석)</button>
                    <button type="button" class="seat_2" onclick="selectSeat('7번 테이블')">7번 테이블<br>(2인석)</button>
